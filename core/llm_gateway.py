...
Supports automatic cascading across Gemini, Groq, Cerebras, Anthropic, Nvidia, OpenRouter, and Ollama.
No dependencies on external agent frameworks.
"""
...
class LLMGateway:
    """Lightweight, resilient multi-provider LLM transport with automated fallback."""
